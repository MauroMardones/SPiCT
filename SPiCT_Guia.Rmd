...
Usaré el ejemplop de datos de erizo de la zona X Norte
```{r}
...
Primro un vistazo a mis datos y compruebo el contraste, el que desde tya nos di´ra que tan robusta es la estimación
```{r}
